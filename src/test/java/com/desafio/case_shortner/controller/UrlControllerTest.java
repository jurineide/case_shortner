...
public class UrlControllerTest {
    ...
    void createUrl_shouldReturn201WithValidResponse() throws Exception {
        CreateUrlRequestDto request = new CreateUrlRequestDto("https://www.itau.com.br/minha-conta", null, null);
        ...
        UrlResponseDTO response = objectMapper.readValue(result.getResponse().getContentAsString(), UrlResponseDTO.class);
    ...
    void createUrl_shouldReturn409_whenCustomAliasDuplicated() throws Exception {
        ...
        CreateUrlRequestDto second = new CreateUrlRequestDto("https://bradesco.com.br", null, "duplicated");
    ...
    void getUrl_shouldReturn404_whenNotFound() throws Exception {
        mockMvc.perform(get("/v1/urls/nonexistent"))
    ...
    void redirect_shouldReturn410_whenUrlExpired() throws Exception {
        ...
        mockMvc.perform(get("/" + response.id()))
    ...
    void listUrls_shouldReturnPage() throws Exception {
        ...
        mockMvc.perform(get("/v1/urls?page=0&size=10"))
                .andExpect(status().isOk())
    ...
    private String createUrl(String originalUrl) throws Exception {
        ...
        MvcResult result = mockMvc.perform(post("/v1/urls")
                ...
                .andExpect(status().isCreated())
                .andReturn();
        return objectMapper.readValue(result.getResponse().getContentAsString(), UrlResponseDTO.class).id();
    }
}
